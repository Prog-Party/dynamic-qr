...
internal static class HttpRequestDataExtensions
{
    ...
    internal static string GetAttribute<T>(this Microsoft.Azure.Functions.Worker.Http.HttpRequestData req)
    ...
    internal static bool HasAttribute<T>(this Microsoft.Azure.Functions.Worker.Http.HttpRequestData req)
        where T : OpenApiHeaderAttribute
    {
        var headerName = Activator.CreateInstance<T>().Name;
